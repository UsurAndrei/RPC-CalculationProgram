...
calc_prog_1(struct svc_req *rqstp, register SVCXPRT *transp)
{
	...
	case calcAvg:
		_xdr_argument = (xdrproc_t) xdr_clientData1;
		_xdr_result = (xdrproc_t) xdr_double;
		local = (char *(*)(char *, struct svc_req *)) calcavg_1_svc;
		break;

	case calcMaxMin:
		_xdr_argument = (xdrproc_t) xdr_clientData2;
		_xdr_result = (xdrproc_t) xdr_returnData2;
		local = (char *(*)(char *, struct svc_req *)) calcmaxmin_1_svc;
		break;

	case calcMult:
		_xdr_argument = (xdrproc_t) xdr_clientData3;
		_xdr_result = (xdrproc_t) xdr_returnData3;
